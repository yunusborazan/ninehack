...
/*     */       }
/*     */       try {
/* 447 */         if (!this.owner.equals(Type.getType(this.owner).getDescriptor())) {
/* 448 */           throw new InvalidMemberDescriptorException("Invalid owner type specified: " + this.owner);
/*     */         }
/* 450 */       } catch (Exception ex) {
/* 451 */         throw new InvalidMemberDescriptorException("Invalid owner type specified: " + this.owner);
/*     */       } 
/*     */     } 
/*     */ 
/*     */     
...
/* Location:              C:\Users\tarka\Downloads\ninehack-1.0.1-release.jar!\org\spongepowered\asm\mixin\injection\struct\MemberInfo.class
