...
/*     */ 
/*     */       
/* 203 */       List<String> reparsedCoremods = (List<String>)mdGetReparsedCoremods.invoke(null, new Object[0]);
...
/* 228 */     ITweaker wrapper = (ITweaker)mdLoadCoreMod.invoke(null, new Object[] { Launch.classLoader, coreModName, this.container });
/* 229 */     if (wrapper == null) {
...
/* 303 */       IRemapper remapper = (IRemapper)mdCreate.invoke(null, new Object[0]);
...
/*     */     } 
/*     */     
/* 398 */     return (List<String>)mdGetIgnoredMods.invoke(null, new Object[0]);
/*     */   }
/*     */ }


/* Location:              C:\Users\tarka\Downloads\ninehack-1.0.1-release.jar!\org\spongepowered\asm\launch\platform\MixinPlatformAgentFML.class
